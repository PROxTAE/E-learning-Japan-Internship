...
const en = {
  ...
  present: {
    ...
    summary: (students: number, questions: number) => `${students} student${students !== 1 ? "s" : ""} • ${questions} question${questions !== 1 ? "s" : ""}`,
    studentCount: (n: number) => `${n} student${n !== 1 ? "s" : ""}`,
    questionAbbr: (n: number) => `Q${n}`,
    liveQuizSession: "Live Quiz Session",
...
const th: typeof en = {
  ...
  present: {
    liveProgress: "ความก้าวหน้าแบบสด",
    quiz: "แบบทดสอบ",
    live: "สด",
    start: "เริ่มต้น",
    finish: "เสร็จสิ้น",
    ...
    summary: (students: number, questions: number) => `นักเรียน ${students} คน • คำถาม ${questions} ข้อ`,
    studentCount: (n: number) => `${n} คน`,
    questionAbbr: (n: number) => `ข้อ ${n}`,
    liveQuizSession: "เซสชันควิซสด",
    leaderboard: "ตารางคะแนน",
    questions: "คำถาม",
    score: "คะแนน",
    roadmap: "แผนผังความก้าวหน้า",
  },
};
...
const ja: typeof en = {
  ...
  present: {
    ...
    inProgress: "進行中",
    summary: (students: number, questions: number) => `学生 ${students} 名 • 問題 ${questions} 問`,
    studentCount: (n: number) => `${n} 名`,
    questionAbbr: (n: number) => `問${n}`,
    liveQuizSession: "ライブクイズセッション",
    leaderboard: "リーダーボード",
    questions: "問題",
    score: "スコア",
    roadmap: "ロードマップ",
