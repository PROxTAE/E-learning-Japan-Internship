            ...
            <AccordionItem
              ...
              subtitle={
                <div className="pl-8 pt-1">
                  <Chip 
                    size="sm" 
                    color={review.isCorrect ? "success" : review.selectedChoiceId === null ? "default" : "danger"} 
                    variant="flat"
            ...
            >
              <div className="pl-8 pr-4 pb-4 flex flex-col gap-3 text-sm">
                <div className="bg-zinc-50 dark:bg-zinc-800/50 rounded-xl p-3 border border-zinc-100 dark:border-zinc-700/50">
                  <span className="text-xs font-bold uppercase tracking-wider text-zinc-500 mb-1 block">Your Answer</span>
                ...
                {!review.isCorrect && (
                  <div className="bg-emerald-50 dark:bg-emerald-900/10 rounded-xl p-3 border border-emerald-100 dark:border-emerald-800/30">
                    <span className="text-xs font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-500 mb-1 block">Correct Answer</span>
